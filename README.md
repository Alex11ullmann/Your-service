...
- Definición general del funcionamiento de la plataforma.

- Organización del código en frontend, backend y base de datos.
...
- Implementación del sistema de suscripciones para resaltar card trabajador.
