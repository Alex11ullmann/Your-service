...
export const CuerpoParaHome = () => {
    return (
        <>
            ...
            <div className="registroPagoAviso">
                <h3>¿Querés saber cómo registrarte?</h3>
                <h4>Activá tu perfil abonando un pequeño costo de registro y asi poder acceder a la informacion de contacto de estos prefesionales</h4>
            </div>
