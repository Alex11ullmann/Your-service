...
const nombre=       ["juan",        "lucas",          "alexis",        "pablo",                  "pedro",        "maria",          "jose",         "Mauricio",         "Agustin",          "juana"];
const calificacion= ["⭐⭐",       "⭐⭐⭐",       "⭐⭐⭐⭐",    "⭐⭐⭐⭐⭐",          "⭐⭐",         "⭐⭐⭐",        "⭐⭐",        "⭐⭐⭐",          "⭐⭐",            "⭐⭐⭐"];
...
function crearLista (dirimagenes,arraynombre,arrayCalificacion,telefono){
    for(let i=0;i<arraynombre.length;i++){
        ...
        img.height=170;
         ...
         //contactar.addEventListener('click', contactarTrabajador(telefono[i])); //primero validamos, luego llamos funcion de compra;
        ...
        lista.appendChild(li);//Creolista con imagen, texto .
